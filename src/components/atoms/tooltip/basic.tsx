...
import { motion } from "@/components/atoms/animate/framer-motion";
  ...
  return (
    <div data-testid="tooltip-container" className="relative inline-block">
      ...
      {visible && (
        <motion.div
          data-testid="title"
          className="absolute bottom-full mb-2 hidden w-max max-w-xs rounded bg-neutral-500 px-2 py-1 text-xs font-medium text-neutral-100 dark:text-neutral-700 lg:block"
